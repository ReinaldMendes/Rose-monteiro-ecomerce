...
export default function SuccessPage() {
  ...
  const waMsg       = `Olá! Acabei de fazer o pedido ${orderNumber} no site. Gostaria de confirmar os detalhes.`
  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="font-display text-4xl italic font-light text-charcoal mb-3">Pedido confirmado!</h1>
        {orderNumber && (
          <div className="bg-white border border-nude px-6 py-4 mb-6 inline-block">
            <p className="text-[10px] tracking-[0.2em] uppercase text-charcoal/45 mb-1">Número do pedido</p>
        ...
        <p className="text-sm text-charcoal/65 font-light leading-relaxed mb-8">
          Recebemos seu pedido! Em breve entraremos em contato pelo WhatsApp para confirmar os detalhes e combinar o pagamento.
        </p>
