  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 min-h-[580px]">
      ...
      <div className="relative bg-nude overflow-hidden min-h-[420px] md:min-h-0">
        ...
        {/* Tag flutuante — "joias em cerâmica" */}
        <div className="absolute bottom-8 left-8 z-10">
          <p className="font-display text-3xl font-light italic text-white/80 leading-tight drop-shadow-lg">
            joias em
          </p>
          <p className="font-display text-3xl italic text-terra leading-tight drop-shadow-lg">
            cerâmica
          </p>
        </div>
